...
echo "         sudo apt install linux-headers-amd64 nvidia-driver nvidia-driver-libs:i386 firmware-misc-nonfree"
...
echo "  □  GNOME on Wayland (GDM, extensions, NVIDIA modeset):"
echo "       Follow docs/debian-setup.md sections 2 and 7, then reboot"
echo "  □  Optional i3 session (pick \"i3\" from GDM's gear menu):"
echo "         sudo apt install i3-wm i3lock xss-lock picom"
echo ""
